...
import { getNewToken } from "../server"
...
export const getCal = async (oAuth2Client: OAuth2Client) => {
    try {
...
async function getFreeTime(auth: OAuth2Client) {
...
// }
// function listEvents(oAuth2Client: OAuth2Client) {
//     throw new Error("Function not implemented.");
// }
